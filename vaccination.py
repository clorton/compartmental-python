...
def run_cms():
    ...
    (time-event sia 75 ((V (/ S 3)) (S (- S V)) (R (+ R V))))
...
class SEIR(gillespy2.Model):
    ...
    def __init__(self):
        ...
        set_vaccinated = gillespy2.EventAssignment(variable=vaccinated, expression="susceptible / 3")
        remove_susceptible = gillespy2.EventAssignment(variable=s, expression="susceptible - vaccinated")
        update_recovered = gillespy2.EventAssignment(variable=r, expression="recovered + vaccinated")
        trigger = gillespy2.EventTrigger(expression="True", initial_value=False, persistent=True)
        sia = gillespy2.Event("sia", delay="75", assignments=[ set_vaccinated, remove_susceptible, update_recovered],
